...
export default {
  ...
  methods: {
    ...
    goSearch() {
      ...
      // 如果路由要求传递parasm参数，但是你就不传递params参数，发现一件事情，URL会有问题的
      // 如何指定params参数可以传递、或者不传递，在配置路由的时候，在占位的后面加上一个?【params可以传递或者不传递】
      /* this.$router.push({
        name:'search',
        query:{
          k:this.keyword.toUpperCase()
      ...
      // 使用undifined解决：parmas参数可以传递、不传递（空的字符串）
      /* this.$router.push({
